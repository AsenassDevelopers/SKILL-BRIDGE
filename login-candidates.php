...
<head>
  ...
  <title>SkillBridge | Professional Login</title>
  <meta name="description" content="Login to your SkillBridge professional account">
...
<div class="login-container">
  <div class="login-card">
    <div class="login-header">
      ...
      <p class="login-subtitle">Professional Services Platform</p>
    </div>
    
    <div class="login-body">
      <h2 class="text-center mb-4">Professional Login</h2>
      
      <?php 
      // Success message for registration
      if(isset($_SESSION['registerCompleted'])) {
      ?>
        <div class="alert-message alert-success text-center">
          <i class="fas fa-check-circle me-2"></i> Check your email for activation!
        </div>
      <?php
      ...
      ?>
        <div class="alert-message alert-success text-center">
          <i class="fas fa-check-circle me-2"></i> Your account is active. You can now login.
        </div>
      <?php
      ...
      ?>
        <div class="alert-message alert-error text-center">
          <i class="fas fa-exclamation-circle me-2"></i> <?php echo $_SESSION['loginActiveError']; ?>
        </div>
      <?php
      ...
      <div class="text-center mt-4">
        <p class="mb-2">Don't have an account? <a href="sign-up.php" class="forgot-link">Register here</a></p>
        <p class="mb-0">Are you a business? <a href="login-company.php" class="forgot-link">Business login</a></p>
      </div>
    </div>
  </div>
</div>
